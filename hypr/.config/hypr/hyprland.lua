...
-- hl.bind(mainMod .. " + P", hl.dsp.window.pseudo()) -- Idk what this is
...
--hl.bind("SUPER + F11", hl.dsp.fullscreen_state({ internal = 0, client = 2 }))
